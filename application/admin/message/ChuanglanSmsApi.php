...
class ChuanglanSmsApi {
    ...
    const API_ACCOUNT='I5958275';//Get SMS Account  from  https://zz.253.com/site/login.html

    const API_PASSWORD='wjh4cT8vD';//Get SMS Password  from https://zz.253.com/site/login.html
    /**
     * 发送短信
     *
