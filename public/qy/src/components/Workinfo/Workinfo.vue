		...
		<div style="width: 1200px;margin: 0 auto;padding: 50px 0;display: flex;flex-wrap: nowrap;justify-content: space-between;height: auto;margin-top: 110px;">
			...
			<div class="left">
				<div class="l-top">
					...
					<div class="l-t-tag">
						<div class="tag" v-for="(tag,index) in list.labelIds" :key="index">{{tag}}</div>
					</div>
				</div>
				<div class="l-mod">
					<div class="l-r-list">
					...
					<div class="list" v-for="(item, index) in items" :key="index" @click="go(item.id)">
						...
						<div class="i-list">
							...
							<div style="width: 100%;display: flex;flex-wrap: nowrap;align-items: center">
								...
								<div style="width: 120px;height: 34px;border:1px solid rgba(0,132,255,1);border-radius:18px;text-align: center;line-height: 34px;font-size:18px;font-family:AlibabaPuHuiTiR;font-weight:400;color:rgba(0,132,255,1);">
									接单
								</div>
							</div>
						</div>
