<template>
	<view>
		...
		<view>
			...
			<view class="cu-form-group" @tap="showModal" data-target="DialogModal1">
			...
			<view class="cu-form-group">
				...
				<input placeholder="请填写期望薪资" name="input" v-model="salary" type="number"></input>
			</view>
			<view class="cu-form-group">
...
<style>
	...
	.xx{background: #fff;}
	.grace-filter-buttons1{display:flex; width:100%; flex-wrap:nowrap;height:90upx; background:#FFF;}
